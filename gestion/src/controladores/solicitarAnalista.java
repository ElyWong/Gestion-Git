...
/**
 * Servlet implementation class solicitarAnalista
 */
@WebServlet("/solicitarAnalista")
public class solicitarAnalista extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public solicitarAnalista() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			if(consultas.solicitarDocumentoAnalista(Integer.valueOf(idUsuario), motivo, tipoDoc, Integer.valueOf(boleta)) == false) {
		...
		request.getRequestDispatcher("consultarAnalista.jsp").forward(request, response);
