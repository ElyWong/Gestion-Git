...
/**
 * Servlet implementation class solicitarJefeArea
 */
@WebServlet("/solicitarJefeArea")
public class solicitarJefeArea extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public solicitarJefeArea() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			if(consultas.solicitarDocumentoJefe(Integer.valueOf(idUsuario), motivo, tipoDoc, Integer.valueOf(boleta)) == false) {
		...
		request.getRequestDispatcher("consultarJefeArea.jsp").forward(request, response);
