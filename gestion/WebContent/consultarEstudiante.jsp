...
<!--/Slider-->
  ...
  <section class="main-info">
			...
			<h3 align="center">A continuación se muestran las solicitudes que has hecho a traves del sistema o en ventanilla y el estado en que se encuentra;
			consulta el estado durante el periodo según sea el trámite para pasar a ventanilla y recoger tu comprobante.</h3>
			<br><br>
