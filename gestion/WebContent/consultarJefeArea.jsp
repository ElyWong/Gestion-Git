...
<script>
	$(function(){
		...
		$("#tabla").append("<thead><tr><th>Fecha</th><th>Boleta</th><th>Trámite</th><th>Motivo</th><th>Estado</th></tr></thead>");
  		$("#tabla").append(data); 
...
<header class="navbar" data-spy="affix" data-offset-top="100" id="miMenu">
	<section class="fondoBlanco">
        ...
        <!--<a id="logo" class="pull-left" href="index.php"></a>-->
     	<div class="nav-collapse collapse pull-right">
      	<ul class="nav">
			<li class="active"><a href="consultarJefeArea.jsp">Consultar estado de solicitudes</a></li>
			<li ><a href="solicitar.jsp">Solicitar trámite</a></li>
...
<!--/Slider-->
  ...
  <section class="main-info">
			...
			<h3 align="center">A continuación se muestran las solicitudes que has hecho a traves del sistema y el estado en que se encuentra;
			consulta el estado durante el periodo según sea el trámite para pasar a ventanilla.</h3>
			<br><br>
