  ...
  <section class="main-info">
	...
	<div class="container">
          ...
          <form action="RegistroCorreo" onsubmit="return myFunction()" method="post" align="center">
            ...
            <br>
            <input type="password" name="pass0" id="pass0" placeholder="Contraseña anterior" style="text-align:center;" required>
            <br>
            <input type="password" name="pass1" id="pass1" placeholder="Contraseña nueva" style="text-align:center;" required>
            <br>
            <input type="password" name="pass2" id="pass2" placeholder="Contraseña nueva" style="text-align:center;" required>
            <br><br>
