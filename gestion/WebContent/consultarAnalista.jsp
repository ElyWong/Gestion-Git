...
<script>
	$(function(){
		...
		$("#tabla").append("<tr><th></th><th>Fecha</th><th>Boleta</th><th>Trámite</th><th>Motivo</th><th>Estado</th><th></th></tr>");
  		$("#tabla").append(data); 
	});
</script>
...
<!--/Slider-->
  ...
  <section class="main-info">
			...
			<h3 align="center">A continuación se muestran las solicitudes que se han hecho atraves del sistema, en el estado podrás modificarlo 
